...
export const treatmentPlanExercises = pgTable("treatment_plan_exercises", {
  ...
  treatment_plan_id: uuid("treatment_plan_id")
  ...
  expected_sessions_count: integer("expected_sessions_count")
    .default(0)
    .notNull(),
  completed_sessions_count: integer("completed_sessions_count")
    .default(0)
    .notNull(),
  notes: text("notes"),
