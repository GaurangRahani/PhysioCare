...
export const exerciseLogs = pgTable(
  "exercise_logs",
  {
    ...
    treatment_plan_exercise_id: uuid("treatment_plan_exercise_id").references(
    ...
    doctor_reviewed: boolean("doctor_reviewed").default(false).notNull(),
  ...
  (table) => ({
    ...
    uniqueLog: unique().on(
      table.patient_id,
      table.treatment_plan_exercise_id,
      table.log_date,
