import { pgTable, uuid, varchar, timestamp, pgEnum, date, time } from "drizzle-orm/pg-core";
...
export const appointments = pgTable("appointments", {
    ...
    payment_status: appointmentPaymentStatusEnum("payment_status").default("pending").notNull(),
