...
import { createConsultation, getConsultationById } from '../controllers/consultation.controller.js';
...
router.post('/', requireAuth, requireRole(['doctor']), validate(createConsultationSchema), createConsultation);
